...
data.frame(
  counts_total = counts(data_before_filtering[,1])[[1]], 
  counts_allelic = (counts_active(data_before_filtering[,1]) +  counts_inactive(data_before_filtering[,1]))[[1]]
) %>%
...
ggsave("./FiguresIllustrator/FigS1/mapped_reads.pdf")

data.frame(
  chromosome = as.character(seqnames(rowRanges(data_with_autosomes))) == "X", 
  total = (counts_active(data_with_autosomes[,1]) + counts_inactive(data_with_autosomes[,1]))[[1]], 
  ase =  (counts_active(data_with_autosomes[,1]) / (counts_active(data_with_autosomes[,1]) + counts_inactive(data_with_autosomes[,1])))[[1]]
) %>%
  ggplot(aes(x = ase, fill = chromosome)) + geom_density() + theme_paper() + ylab("Density") + xlab("B6 / (B6 + CAST)")
ggsave("./FiguresIllustrator/FigS1/density_ase.pdf")
...
name_conversion_condition <- list(
  ...
  "Aux_9_Dox_7_WO_YES_WOAuxNO" = "Dox (7d) - washout, Aux (9d)", 
  "Aux_9_Dox_7_WO_YES_WOAuxYES" = "Dox (7d) - washout (with Aux), Aux (9d)", 
  "Aux_0_Dox_14_WO_NO_WOAuxNO" = "Dox (14d)", 
  "Aux_0_Dox_21_WO_YES_WOAuxNO" = "Dox (21d) - washout", 
  #  "Aux_0_Dox_7_WO_NO_WOAuxNO" = "Dox (7d)", 
  "Aux_0_Dox_7_WO_YES_WOAuxNO" = "Dox (7d) - washout", 
  "Aux_0_Dox_14_WO_YES_WOAuxNO" = "Dox (14d) - washout", 
  "Aux_0_Dox_21_WO_YES_long_WOAuxNO" = "Dox (21d) - washout_long", 
  "Aux_0_Dox_21_WO_NO_WOAuxNO" = "Dox (21d)",
  "Aux_0_Dox_14_WO_YES_WOAuxNO" = "Dox (14d) - washout",
  "Aux_0_Dox_14_WO_YES_long_WOAuxNO" = "Dox (14d) - washout_long"
)
...
data_here <- data[,data$Condition %in% c("Aux_0_Dox_0_WO_NO_WOAuxNO", "Aux_0_Dox_3_WO_NO_WOAuxNO", "Aux_0_Dox_3_WO_YES_WOAuxNO", 
                                         ...
                                         "Aux_0_Dox_21_WO_YES_WOAuxNO", "Aux_0_Dox_7_WO_NO_WOAuxNO", "Aux_0_Dox_7_WO_YES_WOAuxNO", 
                                         "Aux_0_Dox_14_WO_YES_WOAuxNO", "Aux_0_Dox_21_WO_YES_long_WOAuxNO", "Aux_0_Dox_0_WO_NO_WOAuxNO", 
                                         "Aux_0_Dox_21_WO_NO_WOAuxNO", "Aux_0_Dox_14_WO_YES_WOAuxNO")]
...
data_here <- data[,data$Clone == "E6" & data$Condition %in% c("Aux_0_Dox_0_WO_NO_WOAuxNO", "Aux_0_Dox_7_WO_NO_WOAuxNO")]
...
data_for_sf <- data_for_sf[,data_for_sf$Clone == "E6" & data_for_sf$Condition %in% c("Aux_0_Dox_0_WO_NO_WOAuxNO", "Aux_0_Dox_7_WO_NO_WOAuxNO")]
...
data.frame(
  Expression = as.numeric(assays(deseq_active)[["logcounts"]]["Hcfc1", ]), 
...
data.frame(
  expression = assays(deseq_autosomes)[["logcounts"]]["Id4", ], 
  condition = deseq_inactive$Condition, 
...
data_here_washout <- data[,data$Clone == "E6" & data$Condition %in% c("Aux_0_Dox_0_WO_NO_WOAuxNO", "Aux_0_Dox_7_WO_NO_WOAuxNO", "Aux_0_Dox_7_WO_YES_WOAuxNO")]
...
data.frame(
  expression = assays(deseq_autosomes_washout)[["logcounts"]]["Adamtsl3", ], 
...
data.frame(
  ...
  fcs_cont_xist = rowMeans(logcounts(data_here_washout[,data_here_washout$Condition == "Aux_0_Dox_7_WO_NO_WOAuxNO"]))[genes_regulated] - 
    rowMeans(logcounts(data_here_washout[,data_here_washout$Condition == "Aux_0_Dox_0_WO_NO_WOAuxNO"]))[genes_regulated], 
  fcs_xist_washout = rowMeans(logcounts(data_here_washout[,data_here_washout$Condition == "Aux_0_Dox_7_WO_YES_WOAuxNO"]))[genes_regulated] - 
    rowMeans(logcounts(data_here_washout[,data_here_washout$Condition == "Aux_0_Dox_7_WO_NO_WOAuxNO"]))[genes_regulated]
) %>%
