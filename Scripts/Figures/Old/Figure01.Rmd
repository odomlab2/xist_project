...
ggsave("./Plots/FigS1/mapped_reads_c30.pdf")
...
ggsave("./Plots/FigS1/density_ase_c30.pdf")
...
data.frame(
  ...
  theme_paper() + geom_vline(xintercept = 10, linetype = "dashed") + xlab("Total reads mapped") + ylab("Allele-specific reads mapped") + 
  geom_abline(linetype = "dashed")
ggsave("./Plots/FigS1/mapped_reads_e6.pdf")
...
data.frame(
  ...
  ggplot(aes(x = ase, fill = chromosome)) + geom_density() + theme_paper() + ylab("Density") + xlab("B6 / (B6 + CAST)")
ggsave("./Plots/FigS1/density_ase_e6.pdf")
...
ggsave("./Plots/FigS1/cl30_escape.pdf", width = 12, height = 8)
...
data.frame(
  ...
  xlab("Total expression (allelic reads)") + ylab("ASE (d-score)")
ggsave("./Plots/FigS1/e6_escape.pdf", width = 12, height = 8)
...
ggsave("./Plots/FigS1/heatmap_ordered.pdf", width = 10, height = 10)
...
ggsave("./Plots/FigS1/heatmap_ordered_streched.pdf", width = 30, height = 10)
...
ggsave("./Plots/FigS1/number_of_escapees_per_clone.pdf", width = 8, height = 8)
...
ggsave("./Plots/FigS1/number_of_escapees_per_clone_stratified.pdf", width = 8, height = 8)
...
ggsave("./Plots/Fig1/xist_overexpression.pdf", width = 4, height = 4)
...
ggsave("./Plots/Fig1/heatmap_ordered.pdf", width = 6, height = 4)
...
ratios %>%
  ...
  ggplot(aes(reorder(name, position), y = interaction(Clone, Condition, sep = " -- "), group = Clone, fill = value, col = value)) + geom_tile(width = 0.9) +
    ...
    scale_x_discrete(labels = genes_of_choice, position = "bottom") + 
    labs(fill = "d-score")
ggsave("./Plots/FigS1/heatmap_ordered_by_clones.pdf", width = 10, height = 10)
...
ggsave("./Plots/Fig1/heatmap_ordered_only_escapees.pdf", width = 20, height = 4)
...
p1 / p2 + plot_layout(heights = c(4, 0.2))
ggsave("./Plots/Fig1/heatmap_ordered_only_escapees_by_position.pdf", width = 20, height = 4)
...
ggsave("./Plots/Fig1/escapee_silencing_boxplots.pdf", width = 9, height = 6)
...
ratios %>%
  ...
  ggplot(aes(x = Condition, y = value, fill = Clone)) + 
    ...
    theme(axis.text.x=element_text(angle = 45, hjust = 1)) + 
    labs(fill = "Escape Category") + xlab("")
ggsave("./Plots/FigS1/escapee_silencing_boxplots_per_clone.pdf", width = 9, height = 6)
...
ggsave("./Plots/FigS1/xist_overexpression_cl30_31.pdf", width = 6, height = 8)
...
ratios %>%
  ...
  ggplot(aes(reorder(name, position), y = Condition, fill = value, col = value)) + geom_tile(width = 0.9) +
    ...
    scale_x_discrete(labels = genes_of_choice, position = "bottom") + 
    labs(fill = "d-score")
ggsave("./Plots/FigS1/heatmap_ordered_cl30_cl31.pdf", width = 10, height = 10)
...
ratios %>%
  ...
  ggplot(aes(reorder(name, position), y = interaction(Clone, Condition, sep = " -- "), group = Clone, fill = value, col = value)) + geom_tile(width = 0.9) +
    ...
    scale_x_discrete(labels = genes_of_choice, position = "bottom") +
    labs(fill = "d-score")
ggsave("./Plots/FigS1/heatmap_ordered_by_clones_cl30_cl31.pdf", width = 10, height = 10)
...
ratios[escapees_cl30, ] %>%
  ...
  ggplot(aes(x = Condition, y = value, fill = escape_status)) + 
    ...
    scale_fill_manual(values = c("grey", "darkgreen", "orange"), labels = c("Silenced / Variable", "Facultative", "Constitutive")) + 
    labs(fill = "Escape Category") + xlab("")
ggsave("./Plots/Fig1/escapee_silencing_boxplots_cl30_cl31.pdf", width = 9, height = 6)
...
ratios %>%
  ...
  ggplot(aes(x = Condition, y = value, fill = Clone)) + 
    ...
    theme(axis.text.x=element_text(angle = 45, hjust = 1)) + 
    labs(fill = "Escape Category") + xlab("")
ggsave("./Plots/FigS1/escapee_silencing_boxplots_per_clone_cl30_cl31.pdf", width = 9, height = 6)
...
p1 / p2 + plot_layout(heights = c(4, 0.2))
ggsave("./Plots/FigS1/cl30_heatmap_ordered_only_escapees.pdf", width = 20, height = 4)
...
p1 / p2 + plot_layout(heights = c(4, 0.2))
ggsave("./Plots/Fig1/cl30_heatmap_ordered_only_escapees_by_position.pdf", width = 20, height = 4)
...
ggsave("./Plots/FigS1/escape_deseq_analysis.pdf", width = 9, height = 6)
...
ggsave("./Plots/FigS1/escape_deseq_analysis_heatmap.pdf", width = 9, height = 30)
...
ggsave("./Plots/FigS1/basal_exp_vs_basal_escape.pdf", width = 9, height = 6)
...
df_here %>% ggplot(aes(x = BasalExpressionLevel, y = EscapeDifference, col = EscapeCategory)) + 
  geom_point() + scale_x_log10() + theme_paper() + scale_color_manual(values = escape_colors) + geom_smooth(method = 'lm', linetype = 'dashed')
ggsave("./Plots/FigS1/basal_exp_vs_basal_escape_diff.pdf", width = 9, height = 6)
...
ggsave("./Plots/FigS1/bic_model_choice.pdf", width = 9, height = 6)
...
ggsave("./Plots/Fig1/half_life_vs_baseline.pdf", width = 9, height = 6)
...
ggsave("./Plots/Fig1/half_life_category.pdf", width = 9, height = 6)
...
merged_df %>%
  ...
  scale_fill_manual(values = escape_colors) + xlab("") + ylab("offset parameter (non-linear regression)") + ggtitle("Residual escape") + 
  ggrepel::geom_text_repel(aes(label = gene))
ggsave("./Plots/Fig1/residual_escape_category.pdf", width = 9, height = 6)
...
plot_decay_gene("Pbdc1", save_plot = T, path = "./Plots/Fig1/")
plot_decay_gene("Med14", save_plot = T, path = "./Plots/Fig1/")
plot_decay_gene("Mecp2", save_plot = T, path = "./Plots/Fig1/")
plot_decay_gene("Tfe3", save_plot = T, path = "./Plots/Fig1/")

genes_plot <- merged_df[merged_df$category == "constitutive", ]$gene
genes_plot <- genes_plot[!is.na(genes_plot)]

for (gene in genes_plot){
  plot_decay_gene(gene, save_plot = T, path = "./Plots/Fig1/")
}
