...
data.frame(
  ...
  theme_paper()
ggsave("./Plots/FigS2/SPEN_Xist_by_sample.pdf")
...
ggsave("./Plots/Fig2/SPEN_Xist_by_condition.pdf")
...
ratios %>%
  ...
  ggplot(aes(x = Condition2, y = value, fill = Clone)) + geom_boxplot(col = "grey") + 
    ...
    xlab("") + theme_paper()
ggsave("./Plots/FigS2/SPEN_escape_by_sample.pdf")
...
ratios[joint_escapees, ] %>%
  ...
  ggplot(aes(x = Condition2, y = value, fill = escape_status)) + geom_boxplot(col = "black") + 
    ...
    xlab("") + theme_paper()
ggsave("./Plots/Fig2/SPEN_escape_by_category_boxplot.pdf", width = 8, height = 6)
...
p1 / p2 + plot_layout(heights = c(4, 0.2))
ggsave("./Plots/Fig2/heatmap_spen_only_escapees_by_position.pdf", width = 13, height = 3.5)
...
ggsave("./Plots/FigS2/SPEN_escape_by_category_boxplot.pdf")
...
df_test %>%
  ...
  ggplot(aes(control - nddox3_treat, nddox3_aux - nddox3_treat, col = escape_status)) + geom_point() + 
    ...
    coord_fixed() + 
    scale_color_manual(values = escape_colors)
ggsave("./Plots/Fig2/spen_vs_dox_model_3d.pdf", width = 8, height = 6)
...
df_test %>%
  ...
  ggplot(aes(control - nddox7_treat, nddox7_aux - nddox7_treat, col = escape_status)) + geom_point() + 
    ...
    coord_fixed() + 
    scale_color_manual(values = escape_colors)
ggsave("./Plots/Fig2/spen_vs_dox_model_7d.pdf", width = 8, height = 6)
