...
data_raw <- read.csv("~/Desktop/Projects/XChromosome_Antonia/Data/May_2022_clones/RNA-seq_NPC_total_counts.txt", sep = "\t") %>%
  column_to_rownames("Geneid")

data <- read.csv("~/Desktop/Projects/XChromosome_Antonia/Data/May_2022_clones/RNA-seq_NPC_allelic_counts.txt", sep = "\t")
...
data_raw <- read.csv("~/Desktop/Projects/XChromosome_Antonia/Data/September_2022/table_raw_counts.txt", sep = "\t")
...
# read in metadata
metadata <- readxl::read_excel("~/Desktop/Projects/XChromosome_Antonia/Data/September_2022/Metadata_Xistlong_Rep1.xlsx")
metadata <- metadata[-c(1:2), -1]
colnames(metadata) <- c("SampleName", "CorrectedSampleName", "Clone", "Addition", "Guide", "Replicate", "ndTreatment", "ndAux", "timeAux", 
                        "ndDox", "timeDox", "washout", "timeWO", "WOwithAux", "reps", "Allele")
...
data_raw <- read.csv("~/Desktop/Projects/XChromosome_Antonia/Data/October_2022/table_raw_counts.txt", sep = "\t")
...
# read in metadata
metadata <- readxl::read_excel("~/Desktop/Projects/XChromosome_Antonia/Data/October_2022/Metadata_RNASeq_Sep2022.xlsx")
metadata <- metadata[-c(1:2), -1]
