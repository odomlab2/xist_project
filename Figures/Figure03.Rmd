...
data.frame(
  ...
  ggplot(aes(x = Condition, y = Expression)) + geom_boxplot() + geom_point() + coord_flip() + 
    ...
    NULL
ggsave("./FiguresIllustrator/FigS3/Washout_Xist_boxplots.pdf")
...
ggsave("./FiguresIllustrator/FigS3/Washout_Xist_barplots.pdf")
...
ratios %>%
  ...
  ggplot(aes(reorder(name, position), y = Condition, fill = value, col = value)) + geom_tile(width = 0.9) +
    ...
    labs(fill = "d-score")
ggsave("./FiguresIllustrator/FigS3/Washout_full_heatmap.pdf")
...
ggsave("./FiguresIllustrator/Fig3/Washout_escape_boxplots.pdf", width = 8, height = 6)
...
ratios[escapees_total, ] %>%
  ...
  ggplot(aes(x = Condition, y = value, fill = escape_status)) + geom_boxplot(col = "black") + 
    ...
    facet_wrap(~TimeSeries, nrow = 1) + scale_fill_manual(values = escape_colors) + 
  labs(colour = "Escape status")
ggsave("./FiguresIllustrator/Fig3/Washout_Xist_boxplots_longwashout.pdf", width = 8, height = 6)
...
ggsave("./FiguresIllustrator/Fig3/heatmap_ordered_only_escapees.pdf", width = 20, height = 4)
...
p1 / p2 + plot_layout(heights = c(4, 0.2))
ggsave("./FiguresIllustrator/Fig3/heatmap_ordered_only_escapees_genomic_order.pdf", width = 20, height = 4)
...
ggsave("./FiguresIllustrator/FigS3/Washout_escape_by_category_boxplot.pdf")
...
ggsave("./FiguresIllustrator/Fig3/washout_vs_dox_model_3d.pdf", width = 8, height = 8)
...
df_test %>%
  ...
  ggplot(aes(control - nddox7_treat, nddox7_washout - nddox7_treat, col = escape_status)) + geom_point() + 
    ...
    coord_fixed() + 
    scale_color_manual(values = escape_colors) + labs(colour = "Escape status")
ggsave("./FiguresIllustrator/Fig3/Washout_vs_dox_model_7d.pdf", width = 8, height = 8)
...
all_coefs %>%
  ...
  ggplot(aes(x = name, y = value, col = escape_status)) + geom_boxplot() + 
    ...
    ylab("Model coefficient") + xlab("") + 
    scale_color_manual(values = escape_colors)
ggsave("./FiguresIllustrator/FigS3/Washout_escape_by_category_boxplot_long.pdf")
...
df_test %>%
  ...
  ggplot(aes(control - nddox14_treat, nddox14_washout - nddox14_treat, col = escape_status)) + geom_point() + 
    ...
    coord_fixed() + 
    scale_color_manual(values = escape_colors) + labs(colour = "Escape status")
ggsave("./FiguresIllustrator/Fig3/washout_vs_dox_model_14d.pdf", width = 8, height = 8)
...
df_test %>%
  ...
  ggplot(aes(control - nddox21_treat, nddox21_washout - nddox21_treat, col = escape_status)) + geom_point() + 
    ...
    coord_fixed() + 
    scale_color_manual(values = escape_colors) + labs(colour = "Escape status")
ggsave("./FiguresIllustrator/Fig3/Washout_vs_dox_model_21d.pdf", width = 8, height = 8)
