...
- WGBS: WGBS data is aligned using the methylseq pipeline (https://nf-co.re/methylseq/2.6.0/) and then preprocessed into (allele-specific) per-base methylation value files using SNP-split.
...
- Figure 2 shows the analysis of escape in astrocytes after Xist overexpression (figure_2_astrocytes.RmD)
- Figure 3 shows the dependency of Xist-mediated silenced to SPEN (figure_3_spen_knockdown.Rmd)
