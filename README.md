...
- WGBS: WGBS data is aligned using the methylseq pipeline (https://nf-co.re/methylseq/2.6.0/) and then preprocessed into (allele-specific) per-base methylation value files (file names?) using SNP-split.
